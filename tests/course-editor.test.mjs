...
test('incomplete publication is blocked before API persistence',async()=>{const u=ui();await u.open();await u.node('#ce-publish').onclick();assert.match(u.node('#ce-message').textContent,/공개 전 확인/);assert.equal(u.saved.plan,null);});
