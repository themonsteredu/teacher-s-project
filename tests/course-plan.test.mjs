...
test('incomplete drafts save but cannot pass publication validation',()=>{const p=plan();p.variants[0].sessions[0].assets.guide={};p.variants[0].sessions[0].record.completion='';const got=normalize(p,context);assert.equal(issues(got).length,1);});
